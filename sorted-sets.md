...
| `ZUNIONSTORE` nhiều ZSet lớn trong request path | CPU spike, **block event loop** ([Redis Overview](./redis-overview.md)) | Materialize định kỳ/background, cache kết quả |
